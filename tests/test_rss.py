...
categories = ['Sports']
entries = rss.update(feed_link='http://news.yahoo.com/rss/sports', feed_id='5200990d1d41c813b222c2c5', language='en', categories=categories, transcoder_type='readability')
