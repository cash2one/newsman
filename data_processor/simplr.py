...
class Simplr:
    regexps = {
        'unlikely_candidates': re.compile("combx|comment|community|disqus| \
                extra|foot|header|menu|remark|rss|shoutbox|sidebar|sponsor| \
                ad-break|agegate|pagination|pager|popup|tweet|twitter", re.I),
        'ok_maybe_its_a_candidate': re.compile("and|article|body|column|main| \
            shadow", re.I),
        ...
        'extraneous': re.compile("print|archive|comment|discuss|e[\-]?mail| \
                share|reply|all|login|sign|single", re.I),
        'div_to_p_elements': re.compile("<(a|blockquote|dl|div|img|ol|p|pre| \
            table|ul)", re.I),
        ...
        'skip_footbote_link': re.compile("^\s*(\[?[a-z0-9]{1,2}\]?|^|edit| \
